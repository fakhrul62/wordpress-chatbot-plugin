...
<div class="aichat-admin" data-page="ai-config">
	...
	<form id="aichat-settings-form">
		<section class="aichat-card">
			...
			<label><?php esc_html_e( 'AI Mode', 'wp-aichat' ); ?><select name="ai_mode"><option value="free_only"><?php esc_html_e( 'Free only', 'wp-aichat' ); ?></option><option value="openai_fallback"><?php esc_html_e( 'OpenAI with free fallback', 'wp-aichat' ); ?></option><option value="openai_only"><?php esc_html_e( 'OpenAI only', 'wp-aichat' ); ?></option></select></label>
			...
			<p class="aichat-note"><?php esc_html_e( 'Free fallback providers are best-effort external services with no uptime guarantee. OpenAI-only mode disables silent fallback provider switching.', 'wp-aichat' ); ?></p>
		...
		<section class="aichat-card">
			...
			<p class="aichat-note"><?php esc_html_e( 'This is sent to the selected online AI provider on every conversation. If override is enabled, use {{knowledge}} where site knowledge should be inserted; otherwise the override replaces generated rules and knowledge entirely. Crawled page content is included in AI context and could contain adversarial prompt text, so crawl only content you trust.', 'wp-aichat' ); ?></p>
